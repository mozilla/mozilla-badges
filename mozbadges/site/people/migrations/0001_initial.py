...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'people_community', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=25, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
        ))
        db.send_create_signal(u'people', ['Community'])
        ...
        db.create_table(u'people_person', (
            ...
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Community'], null=True, blank=True)),
        ...
        m2m_table_name = db.shorten_name(u'people_person_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'people.person'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'people_community')
        ...
        db.delete_table(db.shorten_name(u'people_person_user_permissions'))
